...
const client = makeWaSocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["SC Simple By ytHanMod", "Dekstop", "3.0"]})
console.log(color('[ SC BY HanMod ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : Han-Mod\n➸ Creator : ZIRO\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : HanMod`\n➸ My Instagram : @putrastore_sosmed\n\nDonase Me For Support :\n➸ DONASI : kaga-ada\n\nThanks\n', 'red'))
...
sendMessage(`6287886443789@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
